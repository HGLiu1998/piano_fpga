...
#Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {pmod3_1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pmod3_1}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {pmod3_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pmod3_2}]
#Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {JA[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[2]}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {pmod3_4}]					
...
#Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {pmod2_1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pmod2_1}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {pmod2_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pmod2_2}]
#Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {JC[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JC[2]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {pmod2_4}]					
